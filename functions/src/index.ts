...
exports.checkVotingDeadlines = functions.pubsub.schedule('every 30 seconds').onRun(async (context) => {
            ...
            participants.forEach((participant: { fcmToken: string }) => {
                notifications.push({
                    notification: {
                        ...
                        body: 'The voting for ${data.name} has ended. Check the results now!',
                    },
