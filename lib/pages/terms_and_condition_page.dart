...
class TermsAndConditionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Privacy', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Theme.of(context)
            .colorScheme
            .inversePrimary),),
      ),
          ...
          children: [
            ...
            Center(
              child: Text(
                ...
                style: TextStyle(fontSize: 14, fontStyle: FontStyle.italic, color: Theme.of(context)
                    .colorScheme
                    .inversePrimary),
              ),
            ),
